...
31) Deploy LinkToken.sol in "Apothem" network
32) Deploy Oracle.sol in "Apothem" network by overriding the Link contract address
...
71) Create a bridge to connect external adapter
72) Create a job spec with Oracle address - It will result JOB ID
73) Copy this JOB_ID and feed this in  .env file in API_AccessRequest folder 
